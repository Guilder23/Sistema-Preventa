(function () {
    ...
    function applyFilters() {
        ...
        // Guardar información de foco usando el ID
        var activeInput = document.activeElement;
        if (activeInput && activeInput.name === 'q') {
            sessionStorage.setItem('reportSearchFocusIdDespacho', activeInput.id);
        }
    ...
    function restoreFocus() {
        var focusId = sessionStorage.getItem('reportSearchFocusIdDespacho');
        if (focusId) {
            setTimeout(function() {
                ...
                sessionStorage.removeItem('reportSearchFocusIdDespacho');
            }, 150);
        }
    }
